...
export class ArtistSubscription extends plugin {
    ...
    /**
     * 加载YAML格式的订阅数据
     * @returns {Object} 解析后的订阅数据，如果文件不存在则返回空对象
     */
    loadData() {
     ...
     * 根据不同的环境选择不同的消息发送方式
     * @param {Object} e - 事件对象
     * @param {string|Array} message - 要发送的消息内容
